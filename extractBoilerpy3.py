...
print(type(extractorFull))
print(type(extractorScentences))
...
# print(extractorScentences)

for i in extractorScentences:
    print(i)
    # print(extractorScentences[i])

# re.search(r'^(We){1}.*(rms)',extractorFull)
# res = re.search(f"({extractorScentences[91]}).*({extractorScentences[92]})",extractorFull)
# extractorFull[res.regs[1][1]:res.regs[2][0]]

# for f in extractorScentences:
#     s += f